...
struct funcStruct Complex_funcs[MAX_FUNCS] = {
    {FN1,   UNI_CPLUS,      USES_F,     ALLOWREC,   ' ',    "Cpx +",    YES_L,  X_NEW,      COMP_plus,              T_CPLXADD,      H_CPLXADD},
    {FN2,   UNI_CMINUS,     USES_F,     ALLOWREC,   ' ',    "Cpx --",   YES_L,  X_NEW,      COMP_minus,             T_CPLXSUB,      H_CPLXSUB},
    {FN3,   UNI_CDIV,       USES_F,     ALLOWREC,   ' ',    "Cpx ÷",    YES_L,  X_NEW,      COMP_div,               T_CPLXDIV,      H_CPLXDIV},
    {FN4,   UNI_CMUL,       USES_F,     ALLOWREC,   ' ',    "Cpx ×",    YES_L,  X_NEW,      COMP_mult,              T_CPLXMUL,      H_CPLXMUL},
    {FN5,   UNI_CSIN,       USES_F,     ALLOWREC,   ' ',    "cSIN",     YES_L,  X_NEW,      COMP_sin,               T_CPLXSIN,      H_CPLXSIN},
    {FN6,   UNI_CCOS,       USES_F,     ALLOWREC,   ' ',    "cCOS",     YES_L,  X_NEW,      COMP_cos,               T_CPLXCOS,      H_CPLXCOS},
    {FN7,   UNI_CTAN,       USES_F,     ALLOWREC,   ' ',    "cTAN",     YES_L,  X_NEW,      COMP_tan,               T_CPLXTAN,      H_CPLXTAN},
    {FN8,   UNI_CCHS,       USES_F,     ALLOWREC,   ' ',    "cCHS",     YES_L,  X_NEW,      COMP_CHS,               T_CPLXCHS,      H_CPLXCHS},
    {FN9,   UNI_CCONJ,      USES_F,     ALLOWREC,   ' ',    "Conj",     YES_L,  X_NEW,      COMP_conj,              T_CONJ,         H_CONJ},
    {FN10,  UNI_CEXP,       USES_F,     ALLOWREC,   ' ',    "cEXP",     YES_L,  X_NEW,      COMP_exp,               T_CPLXEXP,      H_CPLXEXP},
    {FN11,  UNI_CLN,        USES_F,     ALLOWREC,   ' ',    "cLN",      YES_L,  X_NEW,      COMP_ln,                T_CPLXLN,       H_CPLXLN},
    {FN12,  UNI_CLOG,       USES_F,     ALLOWREC,   ' ',    "cLOG",     YES_L,  X_NEW,      COMP_log,               T_CPLXLOG,      H_CPLXLOG},
    {FN13,  UNI_CPOW,       USES_F,     ALLOWREC,   ' ',    "cPOW",     YES_L,  X_NEW,      COMP_pow,               T_CPLXPOW,      H_CPLXPOW},
    {FN14,  UNI_CSQRT,      USES_F,     ALLOWREC,   ' ',    "cSQRT",    YES_L,  X_NEW,      COMP_sqrt,              T_CPLXSQRT,     H_CPLXSQRT},
    {FN15,  UNI_CABS,       USES_F,     ALLOWREC,   ' ',    "cABS",     YES_L,  X_NEW,      COMP_abs,               T_CPLXABS,      H_CPLXABS},
    ...
    {FN21,  UNI_VPLUS,      USES_F,     ALLOWREC,   ' ',    "Vect +",   YES_L,  X_NEW,      COMP_VectAddion,        T_VECTADD,      H_VECTADD},
    {FN22,  UNI_VMINUS,     USES_F,     ALLOWREC,   ' ',    "Vect -",   YES_L,  X_NEW,      COMP_VectSubtract,      T_VECTSUB,      H_VECTSUB},
    {FN23,  UNI_VCROSS,     USES_F,     ALLOWREC,   ' ',    "Vect x",   YES_L,  X_NEW,      COMP_VectCross,         T_VECTCROSS,    H_VECTCROSS},
    {FN24,  UNI_VDOT,       USES_F,     ALLOWREC,   ' ',    "Vect o",   YES_L,  X_NEW,      COMP_VectDot,           T_VECTDOT,      H_VECTDOT},
    {FN25,  UNI_VANGLE,     USES_F,     ALLOWREC,   ' ',    "Vect A",   YES_L,  X_NEW,      COMP_VectAngleBetween,  T_VECTANGLE,    H_VECTANGLE},
    {FN26,  UNI_VCONVR,     USES_F,     ALLOWREC,   ' ',    "Vect»R",   YES_L,  X_NEW,      COMP_VectConvertR,      T_VECTCONVERTR, H_VECTCONVERTR},
    {FN27,  UNI_VCONVP,     USES_F,     ALLOWREC,   ' ',    "Vect»P",   YES_L,  X_NEW,      COMP_VectConvertP,      T_VECTCONVERTP, H_VECTCONVERTP},                            
