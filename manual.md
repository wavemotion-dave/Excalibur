...
There was a time when I considered adding graphing capabilities to Excalibur. But that time has passed. Excalibur is designed to be a powerful but simple calculator. When PCs cost thousands of dollars, it made sense to put graphing capabilities on calculators for students and professionals alike. Nowadays, if you want to graph, you’re more than likely to do it with something more powerful – like Excel, Mathcad or Matlab. Like the HP calculators of old, Excalibur is useful as a calculating tool designed to crunch numbers – nothing more. Though it does contain quite a bit of power, and has tons of functionality, it still comes down to basic number crunching. If you need to integrate or plot you should use a different tool.  If you need to put numbers through their paces, Excalibur is your workhorse.

**Algebraic vs RPN Entry**

The predecessor to Excalibur had both an Algebraic Mode \[3+2=\] and an RPN mode \[3 ENT 2 +\] but in late 1995 I made the decision to not port over the Algebraic mode to Excalibur. Could it be added back in? Possibly… with great effort. But I’m not a fan of the notation. I find RPN notation much more consistent and gives me greater confidence when working through large chain calculations. The ability to see intermediate values on the stack as I progress is extremely powerful. Excalibur will remain an RPN calculator. In understand that means that there will be less than a tenth of the potential users of this tool, but Excalibur is faster, smaller and more robust by trying to do one thing well rather than be a jack of all trades.

     Precision, Accuracy and Overflow <!-- /\* Style Definitions \*/ p.MsoNormal, li.MsoNormal, div.MsoNormal {mso-style-parent:""; margin:0in; margin-bottom:.0001pt; mso-pagination:widow-orphan; font-size:10.0pt; font-family:"Times New Roman"; mso-fareast-font-family:"Times New Roman";} h1 {mso-style-next:Normal; margin-top:12.0pt; margin-right:0in; margin-bottom:3.0pt; margin-left:0in; mso-pagination:widow-orphan; page-break-after:avoid; mso-outline-level:1; font-size:16.0pt; font-family:Arial; mso-font-kerning:16.0pt;} a:link, span.MsoHyperlink {color:blue; text-decoration:underline; text-underline:single;} a:visited, span.MsoHyperlinkFollowed {color:purple; text-decoration:underline; text-underline:single;} @page Section1 {size:8.5in 11.0in; margin:1.0in 1.25in 1.0in 1.25in; mso-header-margin:.5in; mso-footer-margin:.5in; mso-paper-source:0;} div.Section1 {page:Section1;} -->

# Precision, Accuracy and Overflow

Currently, Excalibur for Windows uses an 8 byte IEEE floating point representation of all numbers. This means that there are approximately 15 significant digits.
...
In addition, the calculator only does a minimum amount of checking for overflow (numbers greater than the maximum or less than the minimum). The 8 byte float limits for Excalibur are shown below:

DBL\_MIN2.2250738585072014e-308<br>
DBL\_MAX1.7976931348623158e+308<br>

In addition, for programming mode (assuming using full 32-bit word size) the maximum decimal value is:

ULONG\_MAX 4294967295<br>
